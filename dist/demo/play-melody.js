...
import { Duration, KeySignature, Melody, Note, NoteValue, Pitch, Rest, } from "../music/index.js";
const __dirname = dirname(fileURLToPath(import.meta.url));
const outputPath = join(__dirname, "../../out/demo.wav");
const melody = new Melody(new KeySignature(new Pitch("C", 0, 4), "major"), { beats: 4, beatUnit: 4 }, [
